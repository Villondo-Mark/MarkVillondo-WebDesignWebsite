function animationFunction() {
    ...
    leafFloat.style.animation="leafanimations ease-in-out forwards 2.4s 6s";
      ...
      var leafFloat2 = document.getElementById("leaf2");
    
    leafFloat2.style.animation="leafanimations ease-in-out forwards 2.4s 6.8s";
    
        var leafFloat3 = document.getElementById("leaf3");
    
    leafFloat3.style.animation="leafanimations ease-in-out forwards 2.4s 6.3s";
